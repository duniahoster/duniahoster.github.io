...
<div class="row">
    <div class="col-md-4 mb-4">
        <div class="card border--primary mt-2">
            <h5 class="card-header bg--primary">@lang('Leveling Profit Trading')
    ...
    <div class="col-md-4 mb-4">
        <div class="card border--primary mt-2">
            <h5 class="card-header bg--primary">@lang('Bonus Sponsor')
    ...
    <div class="col-md-4 mb-4">
        <div class="card border--primary mt-2">
            <h5 class="card-header bg--primary">@lang('Leveling Profit Harian')
