    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.store.method.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label for="email" class="form-control-label font-weight-bold">Email Addres</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label for="mobile" class="form-control-label font-weight-bold">Mobile Number</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label for="akunmt5" class="form-control-label font-weight-bold">Nomor Akun MT5</label>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group ">
                                <label for="zip" class="form-control-label font-weight-bold">Zip/Postal</label>
