                ...
                <form action="{{route('admin.users.update',[$user->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <form method="post" action="users.create">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" id="email" placeholder="Email Addres" name="email">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-md-6">
                            <form method="post" action="users.create">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" id="mobile" placeholder="Mobile Number" name="mobile">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <form method="post" action="users.create">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="zip" placeholder="Zip/Postal" name="zip">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <form method="post" action="users.create">
                                <div class="form-group">
                                    <label for="zip" class="form-control-label font-weight-bold">@lang('Country') </label>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn--primary btn-block btn-lg">@lang('Add User')
                                </button>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <input type="checkbox" data-width="100%" data-height="44px" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="Add Balance" data-off="@lang('Subtract Balance')" name="act" checked>
                        </div>
